...
<body>
    ...
    <main class="page__main-content">
        <div class="main-content__post-headline">
            <h1 class="post-headline__main-header">The Road Ahead</h1>
            <p class="post-headline__sub-header">The road ahead might be paved - it might not be.</p>
        </div>
        <img src="./images/TheRoadAheadFull.png" alt="TheRoadAhead" class="main-content__illustration">
